...
public class OCSPClientTest {
    ...
    @Test
    public void testValidOCSPResponse() throws IOException {
        ...
        // Test a correct OCSP response byte array
        try {
            OCSPClient.printOCSPResponse(ocspResponse);
            assertTrue(true);
        } catch (IOException | OCSPException | OperatorCreationException e) {
            fail("Unexpected exception: " + e.getMessage());
        }
        System.out.println("Test 'testValidResponse' completed.");
    }

    // Test a too short response
    @Test
    public void testShortArray() {
        byte[] shortArray = new byte[]{48, -126, 3, -71}; // Too short
        assertThrows(IOException.class, () -> OCSPClient.printOCSPResponse(shortArray));
        System.out.println("Test 'testShortArray' completed.");
    }
    
    // Testing null as input
    @Test
    public void testNullArray() {
        byte[] nullArray = null; // Null byte array
        assertThrows(NullPointerException.class, () -> OCSPClient.printOCSPResponse(nullArray));
        System.out.println("Test 'testNullArray' completed.");
    }
}
